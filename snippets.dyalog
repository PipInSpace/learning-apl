...
⍝ ⍺: data as bytes
⍝ ⍵: key as bytes
aes128←{deblock16 {addRoundKey shiftRows to_bits¨subBytes from_bits¨{addRoundKey mixColumns shiftRows to_bits¨subBytes from_bits¨⍵}⍣9 ⊢ addRoundKey ⍵}¨block16 ⍺ ⊣ keys←expandKeys ⍵}
